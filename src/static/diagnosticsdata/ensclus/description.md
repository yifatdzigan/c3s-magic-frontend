...
EnsClus is a cluster analysis tool for ensembles of climate model simulations that was developed for this purpose. It is based on the k-means algorithm and written in python. 
