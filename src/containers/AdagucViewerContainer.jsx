...
export default class AdagucViewerContainer extends Component {
  constructor (props) {
    ...
    this.state = {
      datasets: [
      {
        wmsurl:'https://portal.c3s-magic.eu/wms?DATASET=WP4-6_ISAC_hyint&',
        ...
        wmsurl:'https://portal.c3s-magic.eu/wms?DATASET=WP4-6_ISAC_zmnam&',
        name:'WP4-6_ISAC_zmnam',
        title:'WP4-6_ISAC_zmnam'
      },*/{
        wmsurl:'https://portal.c3s-magic.eu/wms?DATASET=WP4_BSC_Modes of variability&',
        ...
        wmsurl:'https://portal.c3s-magic.eu/wms?DATASET=WP6_BSC_COMBINATION_AND_AREA_AVERAGING&',
        name:'WP6_BSC_COMBINATION_AND_AREA_AVERAGING',
        title:'WP6_BSC_COMBINATION_AND_AREA_AVERAGING'
      },*/{
        wmsurl:'https://portal.c3s-magic.eu/wms?DATASET=WP6_ISAC_teleconnection&',
        ...
        wmsurl:'https://portal.c3s-magic.eu/wms?DATASET=WP7-drought_indicator',
        name:'WP7-drought_indicator',
        title:'WP7-drought_indicator'
      },/*{
        wmsurl:'https://portal.c3s-magic.eu/wms?DATASET=WP7_shapefileselector',
